...
async def who(ctx: interactions.CommandContext, query: str=None):
  ...
  nth=0
  for topCord in (160, 310):
    for leftCord in (240, 350, 460, 570, 680):
      ...
      draw.text((45,2), title, fill=textColor, font=font, anchor='ma')
      ...
      draw.text((45,14), role, fill=textColor, font=font, anchor='ma')
      
      actImage.paste(textWrap, (0, 100), textWrap)
      image.paste(actImage, (leftCord, topCord))
      nth+=1
